...
var { COLLECTION_USER_INFORMATION, COLLECTION_USER_DETAIL, COLLECTION_DEVICE_TOKENS, COLLECTION_SSO_TOKENS, COLLECTION_ADMIN_USER_DETAIL, COLLECTION_CONTENT_WRITER_USER_DETAIL, COLLECTION_SAILS_USER_DETAIL, COLLECTION_SELLER_USER_DETAIL } = require("../constants/collection.constants");
...
const SellerUserDetail = new Schema({
    uid: { type: Schema.Types.ObjectId, ref: COLLECTION_USER_INFORMATION, required: true },
    first_name: { type: Schema.Types.String, min: 3, max: 20, trim: true, default: null },
    last_name: { type: Schema.Types.String, min: 3, max: 20, trim: true, default: null },
    email: { type: Schema.Types.String, required: true, trim: true },
...
mongoose.model(COLLECTION_SELLER_USER_DETAIL, SellerUserDetail);